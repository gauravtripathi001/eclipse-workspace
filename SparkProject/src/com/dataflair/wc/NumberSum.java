    ...
    JavaPairRDD<String, Integer> ones = words.mapToPair(new PairFunction<String, String, Integer>() {
        ...
        public Tuple2<String, Integer> call(String s) {
          if(s.equals("")){
        	...
        	return new Tuple2<>("result", Integer.parseInt(s));
...
//bin/spark-submit --class com.dataflair.wc.NumberSum ../sparkJob.jar ../about-dataflair.txt wc-out-01